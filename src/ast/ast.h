...
#define PAKCAGE_NODE_LIST(V) V(PackageScope)
...
#undef DECLARE_TYPE_EXPR
  ...
  Position pos() const noexcept { return position_; }
...
class StatementList : public AstNode {
 public:
  ...
  bool IsEmpty() const noexcept { return stmt_list_.empty(); }
  ...
  size_t num_children() const noexcept { return stmt_list_.size(); }
...
class KeyValue : public AstNode {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitKeyValue(this); }

  Expression* key() const noexcept { return key_.get(); }
...
class ArrayInstantiation : public Expression {
 public:
  ...
  AssignableList* assignable_list() { return elements_.get(); }
...
class AssignableValue : public Expression {
 public:
  ...
  AstNode* value() const noexcept { return value_.get(); }
...
class AssignableList : public AstNode, public AssignableInterface {
 public:
  ...
  std::vector<std::unique_ptr<AssignableValue>>& nodes() { return nodes_; }
...
class ReturnStatement : public Statement {
 public:
  ...
  AssignableList* assign_list() const noexcept { return assign_list_.get(); }
...
class ImportStatement : public Statement {
 public:
  using Import = boost::variant<std::vector<std::unique_ptr<Identifier>>,
  ...
  bool has_from() const noexcept { return has_from_; }
  ...
  Identifier* as() const noexcept { return as_.get(); }
...
class Block : public Statement {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitBlock(this); }

  StatementList* stmt_list() const noexcept { return stmt_list_.get(); }
...
class ExpressionList : public AstNode {
 public:
  ...
  bool IsEmpty() const noexcept { return exps_.empty(); }
  ...
  size_t num_children() const noexcept { return exps_.size(); }
 ...
 private:
  ...
  ExpressionList(std::vector<std::unique_ptr<Expression>> exps,
                 Position position)
      : AstNode(NodeType::kExpressionList, position), exps_(std::move(exps)) {}
};
...
class EllipsisExpression : public Expression {
 public:
  ...
  Expression* expr() const noexcept { return expr_.get(); }
...
class CmdExpression : public Expression {
 public:
  ...
  Cmd* cmd() const noexcept { return cmd_.get(); }
 ...
 private:
  ...
  CmdExpression(std::unique_ptr<Cmd> cmd, Position position)
      : Expression(NodeType::kCmdExpression, position), cmd_(std::move(cmd)) {}
};
...
class SubShell : public Cmd {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitSubShell(this); }

  Block* block() const noexcept { return block_.get(); }

  bool self_process() const { return self_process_; }
...
class CmdFull : public Cmd {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitCmdFull(this); }
 ...
 private:
  ...
  CmdFull(std::unique_ptr<Cmd> cmd, bool background, Position position)
...
class CmdAndOr : public Cmd {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitCmdAndOr(this); }

  TokenKind kind() const noexcept { return token_kind_; }

  Cmd* cmd_left() const noexcept { return cmd_left_.get(); }

  Cmd* cmd_right() const noexcept { return cmd_right_.get(); }
...
class CmdPipeSequence : public Cmd {
 ...
 private:
  ...
  CmdPipeSequence(std::vector<std::unique_ptr<Cmd>>&& cmds, Position position)
      : Cmd(NodeType::kCmdPipeSequence, position), cmds_(std::move(cmds)) {}
};
...
class CmdPiece : public AstNode {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitCmdPiece(this); }
  ...
  bool blank_after() { return token_.BlankAfter(); }
 ...
 private:
  ...
  CmdPiece(const Token& token, Position position)
      : AstNode(NodeType::kCmdPiece, position), token_(std::move(token)) {}
};
...
class FilePathCmd : public Cmd {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitFilePathCmd(this); }
  ...
  size_t num_children() const noexcept { return pieces_.size(); }
 ...
 private:
  ...
  FilePathCmd(std::vector<std::unique_ptr<AstNode>>&& pieces, Position position)
      : Cmd(NodeType::kFilePathCmd, position), pieces_(std::move(pieces)) {}
};
...
class CmdIoRedirectList : public Cmd {
 public:
  ...
  size_t num_children() const noexcept { return io_list_.size(); }
...
class CmdIoRedirect : public Cmd {
 public:
  ...
  Literal* integer() const noexcept { return integer_.get(); }

  FilePathCmd* file_path_cmd() const noexcept { return fp_cmd_.get(); }
...
class SimpleCmd : public Cmd {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitSimpleCmd(this); }
 ...
 private:
  ...
  SimpleCmd(std::vector<std::unique_ptr<AstNode>>&& pieces, Position position)
      : Cmd(NodeType::kSimpleCmd, position), pieces_(std::move(pieces)) {}
};
...
class AliasDeclaration : public Declaration {
 public:
  ...
  SimpleCmd* cmd() const noexcept { return cmd_.get(); }
...
class CmdValueExpr : public Cmd {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitCmdValueExpr(this); }

  Expression* expr() const noexcept { return expr_.get(); }

  bool blank_after() const noexcept { return blank_after_; }

  bool is_iterator() const noexcept { return is_iterator_; }
...
class ForInStatement : public Statement {
 public:
  ...
  ExpressionList* test_list() const noexcept { return test_list_.get(); }

  Statement* block() const noexcept { return block_.get(); }
 ...
 private:
  ...
  ForInStatement(std::unique_ptr<ExpressionList> exp_list,
                 ...
                 std::unique_ptr<Statement> block, Position position)
...
class DelStatement : public Statement {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitDelStatement(this); }

  ExpressionList* exp_list() noexcept { return exp_list_.get(); }
...
class IfStatement : public Statement {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitIfStatement(this); }

  Expression* exp() const noexcept { return exp_.get(); }

  Statement* then_block() const noexcept { return then_block_.get(); }

  Statement* else_block() const noexcept { return else_block_.get(); }
 ...
 private:
  ...
  IfStatement(std::unique_ptr<Expression> exp,
              ...
              std::unique_ptr<Statement> else_block, Position position)
...
class GlobalAssignmentStatement : public Statement {
 public:
  ...
  AssignmentStatement* assign() const noexcept { return assign_.get(); }
...
class AssignmentStatement : public Statement {
 public:
  ...
  TokenKind assign_kind() const noexcept { return assign_kind_; }

  ExpressionList* lexp_list() const noexcept { return lexp_.get(); }

  AssignableList* rvalue_list() const noexcept { return rvalue_.get(); }
 ...
 private:
  ...
  AssignmentStatement(TokenKind assign_kind,
                      ...
                      std::unique_ptr<AssignableList> rvalue, Position position)
...
class DeferStatement : public Statement {
 public:
  ...
  Statement* stmt() const noexcept { return stmt_.get(); }
...
class BinaryOperation : public Expression {
 public:
  ...
  Expression* left() const noexcept { return left_.get(); }

  Expression* right() const noexcept { return right_.get(); }
...
class VarEnvId : public Expression {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitVarEnvId(this); }
 ...
 private:
  ...
  VarEnvId(const std::string& name, Position position)
      : Expression(NodeType::kVarEnvId, position), name_(name) {}
};
...
class PackageScope : public AstNode {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitPackageScope(this); }
 ...
 private:
  ...
  PackageScope(std::unique_ptr<Identifier> id, Position position)
      : AstNode(NodeType::kPackageScope, position), id_(std::move(id)) {}
};
...
class Slice : public Expression {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitSlice(this); }

  Expression* start_exp() const noexcept { return start_exp_.get(); }

  Expression* end_exp() const noexcept { return end_exp_.get(); }
...
class CompIf : public Expression {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitCompIf(this); }

  Expression* comp_exp() const noexcept { return comp_exp_.get(); }

  std::unique_ptr<Expression> MoveCompExp() { return std::move(comp_exp_); }
...
class CompFor : public Expression {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitCompFor(this); }

  ExpressionList* exp_list() const noexcept { return exp_list_.get(); }

  ExpressionList* test_list() const noexcept { return test_list_.get(); }

  std::unique_ptr<ExpressionList> MoveExpList() { return std::move(exp_list_); }
...
class ListComprehension : public Expression {
 public:
  ...
  Expression* res_exp() const noexcept { return res_exp_.get(); }

  std::unique_ptr<AssignableValue> MoveResExp() { return std::move(res_exp_); }
...
class Array : public Expression {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitArray(this); }

  Expression* index_exp() const noexcept { return index_exp_.get(); }

  Expression* arr_exp() const noexcept { return arr_exp_.get(); }
...
class IfElseExpression : public Expression {
 public:
  ...
  Expression* then_exp() const noexcept { return then_exp_.get(); }

  Expression* else_exp() const noexcept { return else_exp_.get(); }
...
class Attribute : public Expression {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitAttribute(this); }
...
class Argument : public Expression {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitArgument(this); }

  AssignableValue* arg() { return arg_.get(); }
...
class ArgumentsList : public AstNode, public AssignableInterface {
 ...
 private:
  ...
  ArgumentsList(std::vector<std::unique_ptr<Argument>>&& nodes,
                Position position)
      : AstNode(NodeType::kArgumentsList, position), nodes_(std::move(nodes)) {}
};
...
class FunctionCall : public Expression {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitFunctionCall(this); }

  Expression* func_exp() { return func_exp_.get(); }

  bool IsRvalueListEmpty() const noexcept { return args_list_->IsEmpty(); }

  ArgumentsList* args_list() { return args_list_.get(); }
...
class SpecialString : public Expression {
 public:
  ~SpecialString() {}

  virtual void Accept(AstVisitor* visitor) {
    visitor->VisitSpecialString(this);
  }

  Literal* GetString() noexcept { return str_literal_.get(); }
  Identifier* GetIdentifier() noexcept { return identifier_.get(); }

 private:
  friend class AstNodeFactory;

  std::unique_ptr<Literal> str_literal_;
  std::unique_ptr<Identifier> identifier_;

  SpecialString(std::unique_ptr<Literal>&& str_literal,
                std::unique_ptr<Identifier>&& identifier, Position position)
...
class Glob : public Expression {
 public:
  ...
  virtual void Accept(AstVisitor* visitor) { visitor->VisitGlob(this); }
...
class Literal : public Expression {
 public:
  enum Type { kString, kInteger, kReal, kBool };

  virtual ~Literal() {}

  virtual void Accept(AstVisitor* visitor) { visitor->VisitLiteral(this); }

  const Token::Value& value() const noexcept { return value_; }

  Type literal_type() const noexcept { return lit_type_; }
